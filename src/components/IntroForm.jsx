    ...
    <div className="center">
      <form className="pa4 black-80">
        <div className="">
          ...
          <input id="name" name="title" value={title} onChange={handleChange} className="input-reset ba b--black-20 pa2 mb2 db w-100" type="text" aria-describedby="name-desc" />
        ...
        <div className="pv3">
         ...
         <textarea id="comment" name="body" value={body} onChange={handleChange} className="db border-box hover-black w-100 ba b--black-20 pa2 br2 mb2" aria-describedby="comment-desc"></textarea>
